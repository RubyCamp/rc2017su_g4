class Ball < CPCircle
  ...
  def shape_default_image
    image = Image.load('images/hungrybird.png')
  ...
  if Input.key_push?(K_SPACE)
    ...
    @body.p = CP::Vec2.new(3500, 1750)
    @body.v = (vec2(0,0))
    @body.moment = (1)
elsif Input.key_push?(K_2)
    @body.p = CP::Vec2.new(6100, 1750)
    @body.v = (vec2(0,0))
    @body.moment = (1)
elsif Input.key_push?(K_3)
    @body.p = CP::Vec2.new(6800, 1150)
    @body.v = (vec2(0,0))
    @body.moment = (1)
elsif Input.key_push?(K_4)
    @body.p = CP::Vec2.new(3500, 1150)
    @body.v = (vec2(0,0))
    @body.moment = (1)
elsif Input.key_push?(K_5)
    @body.p = CP::Vec2.new(1000, 1150)
    @body.v = (vec2(0,0))
    @body.moment = (1)
 ...
 private
  ...
  if  Input.mouse_down?(M_LBUTTON)
    if @body.p.y.round == 555 || @body.p.y.round == 1155
        jump(rt)
    elsif @body.p.y.round == 1755
        jump(rt)
     else
    end
  end
